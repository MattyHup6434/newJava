...
import com.it.rmu.servic.RegisterService;
...
public class RegisterController {
    ...
    @PutMapping("/update")
    public ResponseModel update(@RequestBody RegisterRequestModel request) {

        ResponseModel response = new ResponseModel();

        try {
            response.setData(registerService.update(request));
            response.setStatus("SUCCESS");
        } catch (Exception e) {
            // TODO: handle exception
            response.setStatus("ERROR");
